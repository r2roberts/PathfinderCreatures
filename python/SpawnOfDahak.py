...
c.offensive_ability("Shrieking Frenzy", action=Actions.FREE,
                    trigger="The spawn of Dahak’s turn begins.", frequency="once per hour", effect="The spawn of Dahak is quickened until the end of its turn, and can use the extra action to Stride or Strike. While in the frenzy, the spawn of Dahak can’t speak and automatically critically fails Stealth checks, due to its loud wailing.")
c.offensive_ability("Thrown Weapon Mastery", desc="Any weapon a spawn of Dahak throws gains the deadly d6 weapon trait. Furthermore, when a spawn of Dahak throws an improvised weapon, it does not take the –2 penalty for doing so, nor does it take a penalty for using a thrown improvised weapon with the nonlethal trait to make a lethal attack.")
