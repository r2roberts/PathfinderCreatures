...
c = creature.Creature("Racharack", lvl=8)
c.traits("UNIQUE", "CE", "SMALL", "CHARAU-KA", "DRAGON", "FIRE", "HUMANOID")
...
c.interaction_ability("Tail Swipe", action=Actions.REACTION, trigger="A creature within reach of Racharak’s tail uses a move action or leaves a square during a move action it’s using.",
