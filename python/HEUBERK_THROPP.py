...
spells = sg.spells(5)
spells.spell("crushing despair")
spells = sg.spells(4)
spells.spell("discern lies")
spells.spell("fly")
spells = sg.spells(3)
spells.spell("dream message")
spells.spell("enthrall")
spells.spell("hypnotic pattern")
spells = sg.spells(2)
spells.spell("invisibility")
spells.spell("mirror image")
spells.spell("paranoia")
spells = sg.spells(1)
spells.spell("charm")
spells.spell("command")
spells.spell("fear")
spells.spell("ray of enfeeblement")
spells = sg.spells(5, is_cantrip=True)
spells.spell("detect magic")
spells.spell("message")
spells.spell("prestidigitation")
spells.spell("read aura")
spells.spell("shield")
